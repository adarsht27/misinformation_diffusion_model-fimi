...
to-report ask-proceed?
  ...
  <widgets>
    <view x="290" wrappingAllowedX="false" y="10" frameRate="30.0" minPycor="-16" height="438" showTickCounter="true" patchSize="13.0" fontSize="10" wrappingAllowedY="false" width="437" tickCounterLabel="ticks" maxPycor="16" updateMode="0" maxPxcor="16" minPxcor="-16"></view>
    <slider x="3" step="0.01" y="106" max="1" display="pForget" height="33" min="0" direction="Horizontal" default="0.2" variable="pForget" width="134" sizeVersion="0"></slider>
    <slider x="3" step="0.01" y="140" max="1" display="pVerify" height="33" min="0" direction="Horizontal" default="0.4" variable="pVerify" width="134" sizeVersion="0"></slider>
    <slider x="138" step="0.01" y="106" max="1" display="beta-spreadingRate" height="33" min="0" direction="Horizontal" default="0.45" variable="beta-spreadingRate" width="150" sizeVersion="0"></slider>
    <slider x="138" step="0.01" y="140" max="1" display="alpha-hoaxCredibility" height="33" min="0" direction="Horizontal" default="0.25" variable="alpha-hoaxCredibility" width="150" sizeVersion="0"></slider>
    <slider x="85" step="1" y="33" max="1000" display="number-of-agents" height="33" min="10" direction="Horizontal" default="1000.0" variable="number-of-agents" width="203" sizeVersion="0"></slider>
    <plot x="730" autoPlotX="true" yMax="1000.0" autoPlotY="true" y="72" xMin="0.0" height="248" legend="true" xMax="300.0" yMin="0.0" display="State-of-people" width="428" sizeVersion="0">
      <setup>set-plot-y-range 0 number-of-agents</setup>
      <update></update>
      <pen interval="1.0" mode="0" display="BELIEVERS" color="-13345367" legend="true">
        <setup></setup>
        <update></update>
      </pen>
      <pen interval="1.0" mode="0" display="SUSCEPTIBLES" color="-7500403" legend="true">
        <setup></setup>
        <update></update>
      </pen>
      <pen interval="1.0" mode="0" display="FACT-CHECKERS" color="-2674135" legend="true">
        <setup></setup>
        <update></update>
      </pen>
    </plot>
    <monitor x="835" precision="17" y="340" height="45" fontSize="11" display="# Vertices" width="70" sizeVersion="0">count turtles</monitor>
    <monitor x="906" precision="1" y="340" height="45" fontSize="11" display="# Edges" width="71" sizeVersion="0">count links</monitor>
    <button x="835" y="405" height="33" disableUntilTicks="false" forever="false" kind="Observer" display="Spring layout" width="80" sizeVersion="0">repeat 50 [ layout-spring turtles links 0.2 5 1 ]</button>
    <note x="740" y="413" backgroundDark="0" fontSize="12" width="91" markdown="false" height="18" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">Improve layout:</note>
    <note x="739" y="352" backgroundDark="0" fontSize="13" width="98" markdown="false" height="18" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">Graph metrics:</note>
    <button x="917" y="405" height="33" disableUntilTicks="false" forever="false" kind="Observer" display="Expansion" width="69" sizeVersion="0">ask turtles [fd 1]</button>
    <monitor x="978" precision="3" y="340" height="45" fontSize="11" display="Avg. Degree" width="80" sizeVersion="0">sum([count link-neighbors] of turtles) / count turtles</monitor>
    <output x="730" y="10" height="60" fontSize="11" width="428"></output>
    <monitor x="1206" precision="0" y="205" height="45" fontSize="11" display="Susceptibles" width="75" sizeVersion="0">count turtles with [state = "S"]</monitor>
    <note x="1209" y="141" backgroundDark="0" fontSize="13" width="54" markdown="false" height="20" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">#Agents:</note>
    <monitor x="1206" precision="0" y="158" height="45" fontSize="11" display="Believers" width="75" sizeVersion="0">count turtles with [state = "B"]</monitor>
    <monitor x="1206" precision="0" y="252" height="45" fontSize="11" display="Fact-checker" width="75" sizeVersion="0">count turtles with [state = "F"]</monitor>
    <note x="1091" y="72" backgroundDark="0" fontSize="14" width="50" markdown="false" height="18" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">Graph</note>
    <slider x="12" step="0.01" y="181" max="1" width="250" display="beta-fc-spread" height="50" min="0" direction="Horizontal" default="0.55" variable="beta-fc-spread"></slider>
    <slider x="10" step="0.01" y="237" max="1" width="250" display="pForget-FC" height="50" min="0" direction="Horizontal" default="0.05" variable="pForget-FC"></slider>
    <chooser x="16" y="296" height="45" variable="Type-of-network" current="0" display="Type-of-network" width="193" sizeVersion="0">
      <choice type="string" value="Barabási–Albert algorithm"></choice>
      <choice type="string" value="Erdős–Rényi model"></choice>
    </chooser>
    <button x="98" y="379" height="62" disableUntilTicks="false" forever="false" kind="Observer" display="SETUP" width="73" sizeVersion="0">setup
</button>
    <button x="195" y="443" height="33" disableUntilTicks="true" forever="false" kind="Observer" display="go-once" width="55" sizeVersion="0">go</button>
    <button x="195" y="379" height="62" disableUntilTicks="false" forever="true" kind="Observer" display="GO" width="73" sizeVersion="0">go</button>
    <note x="16" y="350" backgroundDark="0" fontSize="14" width="150" markdown="false" height="19" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">Main commands</note>
    <switch x="18" y="443" height="33" on="false" variable="PC-low-performance?" display="PC-low-performance?" width="153" sizeVersion="0"></switch>
    <note x="17" y="36" backgroundDark="0" fontSize="14" width="62" markdown="false" height="47" textColorDark="-1" textColorLight="-16777216" backgroundLight="0">Initial setting</note>
  </widgets>
  <info>## WHAT IS IT?
...
Sulis, E., Tambuscio, M. (2020). Simulation of misinformation spreading processes in social networks: an application with NetLogo. In 2020 IEEE International Conference on Data Science and Advanced Analytics (DSAA), IEEE.</info>
  <turtleShapes>
  ...
  <linkShapes>
    ...
    <shape name="curved link" curviness="1.5">
      <lines>
        <line x="-0.2" visible="false">
          <dash value="0.0"></dash>
          <dash value="1.0"></dash>
  ...
  <experiments>
    <experiment name="experiment" repetitions="30" sequentialRunOrder="true" runMetricsEveryStep="true">
      <setup>setup</setup>
      <go>go</go>
      ...
      <constants>
        <enumeratedValueSet variable="Type-of-network">
          <value value="&quot;Barabási–Albert algorithm&quot;"></value>
        </enumeratedValueSet>
